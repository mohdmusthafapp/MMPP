...
//        http://apiservices.newsraft.com/todays?limit=25&offset=2&language=english
    ...
    lazy var applicationDocumentsDirectory: NSURL = {
        // The directory the application uses to store the Core Data store file. This code uses a directory named "com.musthafa.MMNewsRaft.MMNewsRaft" in the application's documents Application Support directory.
    ...
    lazy var managedObjectModel: NSManagedObjectModel = {
        ...
        let modelURL = NSBundle.mainBundle().URLForResource("MMNewsRaft", withExtension: "momd")!
